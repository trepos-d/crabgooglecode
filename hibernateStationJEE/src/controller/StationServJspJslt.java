	...
	@WebServlet("/StationServJspJslt")
	public class StationServJspJslt extends HttpServlet {
		private static final long serialVersionUID = 1L;
	      
	    public StationServJspJslt() {
	        super();
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			request.getRequestDispatcher("vue/AfficheListeStationJslt.jsp").forward(request , response);
		}
