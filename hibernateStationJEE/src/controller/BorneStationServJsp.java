...
@WebServlet("/BorneStationServJsp")
public class BorneStationServJsp extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public BorneStationServJsp() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("vue/BorneStationJSP.jsp").forward(request , response);
	}
